...
class TodoLifecycleTest : BasePlatformTestCase() {
  ...
  /**
   * Menguji pembersihan riwayat (Reset): DONE -> TODO. Riwayat Start, End, dan Cancel harus dihapus agar tidak valid
   * lagi.
   */
  ...
  /** Menguji transisi: CANCELLED -> DOING. cancelDate harus dihapus dan diganti dengan startDate baru. */
