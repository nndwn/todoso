 ...
 * Uses a fully custom renderer to avoid deprecated APIs and achieve modern look.
 */
class SuggestionOverlayPanel(
    private val onItemSelected: (SuggestionItem) -> Unit
    ...
    private val list = JBList(listModel).apply {
        ...
        cellRenderer = ListCellRenderer { list, value, index, isSelected, _ ->
            ...
            if (showHeader) {
                val headerLabel = JBLabel(value.category).apply {
