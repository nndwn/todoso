...
- **Challenge Task**: Randomly pick a Todo task to start working on.
...
### Fixed
- Fixed visibility issues of the Tag Cloud on startup.
- Fixed accidental UI focus states on buttons.
- Improved Markdown parsing reliability.
